        ...
        <div class="row content">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="btn-group btn-group-vertical" data-toggle="buttons">
                                            <label class="btn" onclick="goData(1);">
            ...
            <div class="col-lg-4 sidenav">
                ...
                <div class="">
                    ...
                    <div class="">
                        ...
                        <div id="scroll" class="col-lg-12">
                            ...
                            <c:forEach var="article" items="${testQuiz}" varStatus="status">
                                ...
                                <div class="col-lg-4">
                                    <button class="btn btn-default" type="button" <c:if test="${testType eq '1'}">
                    ...
                    <div class="">
                        <div class="btn-group">
                            <button type="button" class="btn btn-info btn-lg" <c:if test="${testType eq '1'}">
                        ...
                        <div>
                            <!-- 문제제출 버튼 누르면 진단페이지로 가는 경로 여기로 빼논다  onclick="location.href = '/qboard/complete.qu/${testType}'"  -->
                            <button type="button" id="loading-body2-btn" class="btn btn-danger btn-lg btn-block" onClick="delayURL('/qboard/complete.qu/${testType}','3000')">문제제출</button>
                        </div>
                    </div>
                    <!-- 사이드 하단 끝 -->
                </div>
