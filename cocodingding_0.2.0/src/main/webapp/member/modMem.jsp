  ...
  <div id="container">
    ...
    <div id="align">
      <form action="/qboard/modPro.me" method="post">
        ...
        <div id="right_side">
			<input type="text" name="id" value="${userInfo.id}" required="required" readonly><br>
			...
			<input type="text" name="nickname" value="${userInfo.nickname}" required="required"><br>
			<input type="text" name="email" value="${userInfo.email}" required="required"><br>
        </div>
        <div>
