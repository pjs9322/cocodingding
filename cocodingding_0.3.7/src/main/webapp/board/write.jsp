						...
						<section id="writeForm">
							<form class="" action="/qboard/boardInsert.bo" method="post" name="boardform">
								...
								<div class="form-group form-group-lg">
									...
									<div class="col-lg-10">
										<input class="form-control" type="text" name="title" required="required" placeholder="">
									</div>
								</div>
								<div class="form-group form-group-lg">
								...
								<section id="commandCell">
									...
									<input type="button" value="게시판으로 돌아가기" onclick="location.href = '/qboard/boardList.bo/${type}'">
								</section>
							</form>
						</section>
						<!-- 게시판 글쓰기 끝 -->	
