						...
						<section id="modifyForm">
							<form action="/qboard/boardUpdate.bo/${bnum}" method="post" name="boardform">
								<div class="form-group form-group-lg">
									<button type="button" class="btn col-lg-2 btn-primary btn-lg">글쓴이</button>
									<div class="col-lg-10">
										<input type="hidden" name="id" value="${userInfo.id}" required="required" readOnly>
										<input class="form-control" type="text" name="nickname" value="${userInfo.nickname}" required="required" readOnly>
									</div>
								</div>
								<div class="form-group form-group-lg">
									<button type="button" class="btn col-lg-2 btn-primary btn-lg">분야</button>
									<div class="col-lg-10">
								...
								<div class="form-group form-group-lg">
									<button type="button" class="btn col-lg-2 btn-primary btn-lg">제목</button>
									<div class="col-lg-10">
										<input class="form-control" type="text" name="title" required="required" value="${article.title}">
									</div>
								</div>
								<div class="form-group form-group-lg">
									<button type="button" class="btn col-lg-2 btn-primary btn-lg">내용</button>
									<div class="col-lg-10">
								...
								<div class="col-lg-12">
									<div class="alert alert-success col-lg-9" role="alert">
									  	문제 추가하기 버튼으로 틀린문제, 장바구니 문제를 게시물에 추가하여 업로드 할 수 있습니다.
									</div>
									<div class="col-lg-3">
										<button type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target="#makeQuiz">
											문제 추가하기
										</button>
									</div>
								</div>
								...
								<section id="commandCell">
									...
									<input type="button" value="게시글로 돌아가기" onclick="location.href = '/qboard/boardView.bo/${bnum}'">
								</section>
							</form>
						</section>
						<!-- 게시판 글쓰기 끝 -->	
