			...
			<div class="col-lg-10 text-left"> 
				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						...
						<div class="col-lg-12">
							<div class="">
								<form class="" action="/qboard/boardUpdate.bo/${bnum}" method="post" name="boardform">
									<!-- 게시판 본문 -->
									...
									<div class="col-lg-12">
										...
										<div class="alert alert-success col-lg-8" role="alert">
										  	문제 등록하기 버튼으로 틀린문제 및 북마크 문제를 내용에 추가하여 게시할 수 있습니다.
										</div>
										...
										<div class="modal-dialog modal-lg">
											...
											<div class="modal-content">
												<div class="modal-header">
													...
													<h2 class="modal-title" id="myModalLabel">문제 등록하기</h2>
												</div>
												<div class="modal-body">
													<div class="container-fluid">
														<div class="row">
															...
															<c:forEach var="article" items="${list}">
																<textarea name="hidedoc_${article.qnum}" style="display:none;">${article.document}</textarea>
																<textarea name="hidecom_${article.qnum}" style="display:none;">${article.commentary}</textarea>
															</c:forEach>
															...
															<div class="col-lg-12">
																...
																<div class="container-fluid">
																	...
																	<div class="form-horizontal" role="form">
																		...
																		<div class="col-lg-8">
																			<select class="form-control" name="fieldQ">
																				<option>JAVA</option>
																				<option>WEB</option>
																				<option>DataBase</option>
																			</select>
														...
														<div class="row">
															<div class="col-lg-12">
																...
																<div class="container-fluid">
																	<h3>문제 지문</h3>
																	<div class="form-horizontal" role="form">
																		<textarea name="documentQ" class="form-control col-lg-5" rows="5"></textarea>
																	</div>
																	<br/>
																</div>
																<!-- 문제 지문입력 끝 -->
																		...
																		<div class="form-group form-group-lg">
																			<div class="col-lg-12">
																				...
																				<div class="col-lg-3 radio">
																					<input type="radio" name="result" id="" value="1" style="cursor:auto">
																				</div>
																				<br/>
																			</div>
																			...
																			<div class="col-lg-12">
																				...
																				<div class="col-lg-3 radio">
																					<input type="radio" name="result" id="" value="2" style="cursor:auto">
																				</div>
																				<br/>
																			</div>
																			...
																			<div class="col-lg-12">
																				...
																				<div class="col-lg-3 radio">
																					<input type="radio" name="result" id="" value="3" style="cursor:auto">
																				</div>
																				<br/>
																			</div>
																			...
																			<div class="col-lg-12">
																				...
																				<div class="col-lg-6">
																					<input class="form-control" type="text" id="number4" name="choice4">
																				</div>
																				<div class="col-lg-3 radio">
														...
														<div class="row">
															<div class="col-lg-12">
																...
																<div class="container-fluid">
																	<h3>해설 내용 및 정답</h3>
																	<div class="form-horizontal" role="form">
																		<textarea name="commentary" class="form-control col-lg-5" rows="5"></textarea>
																	</div>
																	<br/>
																</div>
																<!-- 해설 내용입력 끝 -->
