		...
		<table class="table">
			...
			<form action="/qboard/replyInsert.bo/${bnum}" method="post" name="replyform">
				...
				<tr>
				    ...
				    <td class="success"><button type="submit" class="btn btn-success center-block">댓글 등록</button></td>
				</tr>
				<!-- 댓글 등록 끝 -->
			</form>
			<!-- 게시판 댓글 끝 -->
...
<td colspan="5" class="text-center">
            	<c:if test="${quiz.qnum ne null}"><input type="button" class="btn btn-success" data-toggle="modal" data-target="#makeQuiz" value="첨부문제"></c:if>
<!-- 문제 보기 모달 -->
...
<h3>문제 지문</h3>
<div class="form-horizontal" role="form">
<textarea name="documentQ" class="form-control col-lg-5" rows="5" required="required">${quiz.document}</textarea>
</div>
<br/>
</div>
<!-- 문제 지문입력 끝 -->
...
<div class="container-fluid">
   <h3>해설 내용 및 정답</h3>
   <div class="form-horizontal" role="form">
      <textarea name="commentary" class="form-control col-lg-5" rows="5" style="cursor:auto">${quiz.commentary}</textarea>
   </div>
   <br/>
</div>
<!-- 해설 내용입력 끝 -->
...
<!-- 문제 추가 폼 끝 -->
					...
					<!-- 문제 보기 모달 끝 -->
					<input type="button" class="btn btn-warning" onclick="location.href='/qboard/boardModifyForm.bo/${bnum}'" value="수정하기">
					<input type="button" class="btn btn-danger"  onclick="board_Delete('${bnum}')" value="삭제하기">
					<input type="button" class="btn btn-primary" onclick="location.href='/qboard/boardList.bo/${type}'" value="목록보기">
					        </td>
					    </tr>
