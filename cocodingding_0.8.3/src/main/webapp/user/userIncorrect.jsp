...
<head>
	...
	<script type="text/javascript">
		...
		function checkField() {
			...
			var frm	= document.IncorrectListform;
	...
	<!-- 게시판 스크립트 설정 끝 -->
  	...
  	<script type="text/javascript">
  		// 문제 삭제 질문 폼
	  	function incorrect_Delete(code) {
	  	    result = confirm('정말로 삭제 하시겠습니까');
	  	    if(result == true){
	  	        location.href = "/qboard/incorrectDelete.ic/" + code;
	  	    }else{
	  	    	return false;
	  	    }
  		}
		...
		<div class="row content">
			...
			<div class="col-lg-10 text-left"> 
				...
				<div class="panel panel-primary">
					...
					<form action ="/qboard/incorrectList.ic" method="get" name="IncorrectListform">
						<!-- 패널바디 -->
						<div class="panel-body">
							<!-- 본문 게시판 -->
							<div class="col-xs-12">
												...
												<c:forEach var="article" items="${list}" begin="${pageVO.curStartNumber}" end="${pageVO.curEndNumber}" varStatus="status">
													<tr>
													    ...
													    <td><!-- 문제 보기 버튼 -->
														    ...
														    <td>
														    	<input type="button" class="btn btn-danger" onclick="incorrect_Delete('${article.qnum}')"  value="삭제">
														    </td>
													  </tr>
												</c:forEach>
											</tbody>
