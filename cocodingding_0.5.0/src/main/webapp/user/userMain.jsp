							...
							<div id="microservices">
								...
								radar.show('#microservices', {
									...
									metrics: [
								    {
								      ...
								      target: ${grade.part1/2 - 1},
								      actual: ${grade.set1/2 - 1}
								    },
								    {
								      name: "Part 2",
								      range: [
								      ...
								      target: ${grade.part2/2 - 1},
								      actual: ${grade.set2/2 - 1}
								    },
								    {
								      name: "Part 3",
								      range: [
								      ...
								      target: ${grade.part3/2 - 1},
								      actual: ${grade.set3/2 - 1}
								    },
								    {
								      name: "Part 4",
								      range: [
								      ...
								      target: ${grade.part4/2 - 1},
								      actual: ${grade.set4/2 - 1}
								    },
								    {
								      name: "Part 5",
								      range: [
								      ...
								      target: ${grade.part5/2 - 1},
								      actual: ${grade.set5/2 - 1}
								    },
								    {
								      name: "Part 6",
								      range: [
								      ...
								      target: ${grade.part6/2 - 1},
								      actual: ${grade.set6/2 - 1}
								    }
								  ]
								});
								</script>
                    					...
                    					<form action="/qboard/user.me" name="userSelectForm" method="get">
											...
											<div class="col-lg-6">
												<select class="form-control" name="levels" onchange="pagingLevels();">
													<c:if test="${grade.levels ge 1}"><option value="1" selected>Lv 1</option></c:if>
													<c:if test="${grade.levels ge 2}"><option value="2" selected>Lv 2</option></c:if>
													<c:if test="${grade.levels ge 3}"><option value="3" selected>Lv 3</option></c:if>
													<c:if test="${grade.levels ge 4}"><option value="4" selected>Lv 4</option></c:if>
													<c:if test="${grade.levels ge 5}"><option value="5" selected>Lv 5</option></c:if>
													<c:if test="${grade.levels ge 6}"><option value="6" selected>Lv 6</option></c:if>
													<c:if test="${grade.levels ge 7}"><option value="7" selected>Lv 7</option></c:if>
													<c:if test="${grade.levels ge 8}"><option value="8" selected>Lv 8</option></c:if>
													<c:if test="${grade.levels ge 9}"><option value="9" selected>Lv 9</option></c:if>
													<c:if test="${grade.levels ge 10}"><option value="10" selected>Lv 10</option></c:if>
												</select>
											</div>
										</form>
									</div>
