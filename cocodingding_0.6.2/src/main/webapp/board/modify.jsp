													...
													<div class="container-fluid">
														<div class="row">
															<div class="col-lg-12">
																...
																<div class="col-lg-12">
																	<select class="form-control" name="qnum" required="required">
																		<option value='0' selected>-- 문제번호 선택 --</option>
																		<c:forEach var="item" items="${list}" varStatus="status">
																			<option value="${item.qnum}" <c:if test="${item.qnum eq article.qnum}">selected</c:if>>${item.qnum} :: ${item.abbrev}</option>
																		</c:forEach>
																	</select>
																</div>
															</div>
