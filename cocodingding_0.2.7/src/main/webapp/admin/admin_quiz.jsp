																						...
																						<br/>
																							...
																							<div class="col-lg-8">
																								<select class="form-control" name="levels" required="required">
																									<option <c:if test="${article.levels eq 'Lv 1'}">selected</c:if>>Lv 1</option>
																									<option <c:if test="${article.levels eq 'Lv 2'}">selected</c:if>>Lv 2</option>
																									<option <c:if test="${article.levels eq 'Lv 3'}">selected</c:if>>Lv 3</option>
																									<option <c:if test="${article.levels eq 'Lv 4'}">selected</c:if>>Lv 4</option>
																									<option <c:if test="${article.levels eq 'Lv 5'}">selected</c:if>>Lv 5</option>
																									<option <c:if test="${article.levels eq 'Lv 6'}">selected</c:if>>Lv 6</option>
																									<option <c:if test="${article.levels eq 'Lv 7'}">selected</c:if>>Lv 7</option>
																									<option <c:if test="${article.levels eq 'Lv 8'}">selected</c:if>>Lv 8</option>
																									<option <c:if test="${article.levels eq 'Lv 9'}">selected</c:if>>Lv 9</option>
																									<option <c:if test="${article.levels eq 'Lv 10'}">selected</c:if>>Lv 10</option>
																								</select>
																							</div>
																						</div>
																						<br/>
