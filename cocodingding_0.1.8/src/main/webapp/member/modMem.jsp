  ...
  <div id="container">
    ...
    <div id="align">
      <form action="/qboard/modPro.me" method="post">
        ...
        <div id="right_side">
			<input type="text" name="id" value="#{userID}" required="required" readonly><br>
			...
			<input type="text" name="nickname" value="#{memberInfo.getNickname()}" required="required"><br>
			<input type="text" name="email" value="#{memberInfo.getEmail()}" required="required" readonly><br>
        </div>
        <div>
