  	...
  	<script type="text/javascript">
	  	...
	  	function end_Quiz() {
	  	    ...
	  	    if(result == true){
                ...
                setTimeout(function(){ location.href = "/qboard/complete.qu/${testType}"; }, 3000);
                ...
                <div class="">
                    ...
                    <div class="">
                        ...
                        <div>
                            ...
                            <button type="button" id="loading-body2-btn" class="btn btn-danger btn-lg btn-block" onClick="end_Quiz()">문제제출</button>
                        </div>
                    </div>
                    <!-- 사이드 하단 끝 -->
                </div>
