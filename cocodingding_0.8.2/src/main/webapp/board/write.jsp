							...
							<div class="table table-responsive col-xs-12">
								<table class="table">
									...
									<tr>
										...
										<td colspan="3">
											<textarea class="form-control" rows="10" name="document" required="required" style="resize: none;"></textarea>
										</td>
									</tr>
								    
									<tr>
										<td colspan="4" class="text-center">
											<button type="button" class="btn btn-warning" onclick="location.href = '/qboard/boardList.bo/${type}'">돌아가기</button>
																		    ...
																		    <div class="table table-responsive">
																		        ...
																		        <table class="table">
																			        <tr>
																			            ...
																			            <td colspan="5">
																							<select class="form-control" name="qnum" onchange="selectQuiz()">
																								...
																								<option value="${item.qnum}">${item.field} :: ${item.abbrev}</option>
																								</c:forEach>
																							</select>
																			            </td>
																					</tr>
																			        ...
																			        <tr>
																			            ...
																			            <td colspan="3">
																			               <textarea class="form-control" name="documentQ" rows="5" style="resize: none;"></textarea>
																			            </td>
																			        </tr>
																			        <tr>
																						...
																						<td>
																							<input type="radio" name="result" id="radio1" value="1" style="cursor:auto">
																			            </td>
																			        </tr>
																			        <tr>
																			        ...
																			        <tr>
																			        	...
																			        	<td colspan="3">
																							<textarea name="commentary" class="form-control" rows="5" style="resize: none;"></textarea>
																						</td>
																			        </tr>
																		        </table>
																		    </div>
