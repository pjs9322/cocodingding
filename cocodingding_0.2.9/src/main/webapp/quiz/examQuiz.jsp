      ...
      <div class="row content">
         ...
         <div class="col-lg-8 text-left"> 
			...
			<div class="">
				...
				<form action="/qboard/diagno.qu/${testQuiz.get(code).field}/${code}" method="post" name="quizform">
            ...
            <div class="">
               ...
               <div class="">
                  ...
                  <div id="scroll" class="col-lg-12">
                     ...
                     <div class="col-lg-5">
                        <button class="btn btn-default" type="button" onclick="location.href = '/qboard/diagno.qu/${article.field}/${status.index}'">Question ${status.count}</button>
                     </div>
                     <div class="col-lg-7">
               ...
               <div class="">
                  <div class="">
                     <button type="button" class="btn btn-primary btn-lg btn-block" onclick="location.href = '/qboard/diagno.qu/${testQuiz.get(code).field}/${code - 1}'">이전문제</button>
                     <button type="button" class="btn btn-primary btn-lg btn-block" onclick="location.href = '/qboard/diagno.qu/${testQuiz.get(code).field}/${code + 1}'">다음문제</button>
                     <button type="button" class="btn btn-danger btn-lg btn-block" onclick="location.href = '/qboard/complete.qu'">문제제출</button>
                  </div>
               </div>
               <!-- 사이드 하단 끝 -->
            </div>
