				...
				<section class="section">
					...
					<div class="section-body">
						<div class="section-body-main">
							<textarea class="section-body-quiz">
			...
			<section id="main-aside"><!-- 본문 사이드 -->
				<div class="aside-list">
					<div id="aside-content">
						<div class="aside-number"><h3>분야</h3></div>
					...
					<div id="aside-content">
						<div class="aside-number"><h3>파트</h3></div>
						<select class="aside-select">
					...
					<div id="aside-content">
						<div class="aside-number"><h3>레벨</h3></div>
						<select class="aside-select">
							<option>Lv 1</option>
							<option>Lv 2</option>
							<option>Lv 3</option>
				...
				<div id="aside-control">
					<div class="aside-button">
						<div id="aside-resist"><h3>문제등록</h3></div>
					</div>
					<div class="aside-button">
						<div id="aside-back"><h3>돌아가기</h3></div>
					</div>
				</div>
			</section>
		</div>
