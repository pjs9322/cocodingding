									...
									<tbody>
										<c:forEach var="article" items="${quizList}" varStatus="status">
											<tr>
											    ...
											    <td><a href="/qboard/admin_modForm.me/${article.qnum}">수정</a></td>
												...
												<div class="row">
													<div class="col-lg-12">
														...
														<div class="container-fluid">
															<h3>문제 지문 입력</h3>
															<form class="form-horizontal" role="form">
																<textarea name="document" class="form-control col-lg-5" rows="5"></textarea>
															</form>
															<br/>
														</div>
														<!-- 문제 지문입력 끝 -->
															...
															<form class="form-horizontal" role="form">
																<div class="form-group form-group-lg">
																	<div class="col-lg-12">
																		...
																		<div class="col-lg-6">
																			<input class="form-control" type="text" id="number1" name="choice1">
																		</div>
																	...
																	<div class="col-lg-12">
																		...
																		<div class="col-lg-6">
																			<input class="form-control" type="text" id="number2" name="choice2">
																		</div>
																		<div class="col-lg-3 radio">
																	...
																	<div class="col-lg-12">
																		...
																		<div class="col-lg-6">
																			<input class="form-control" type="text" id="number3" name="choice3">
																		</div>
																		<div class="col-lg-3 radio">
