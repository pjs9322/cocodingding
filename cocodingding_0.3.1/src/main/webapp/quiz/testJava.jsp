	...
	<div id="section" class="container">
		...
		<div class="col-lg-6 text-left"> 
			...
			<div class="">
				<!-- 상단 -->
				<div class="">
					<h1>JAVA Test - Random Selecting</h1>
					<hr>
				...
				<div class="">
					...
					<div class="btn-group">
						...
						<button type="button" class="btn btn-default btn-lg" onclick="location.href='/qboard/study.qu/JAVA/1/0'">자동문제 풀어보기</button>
						<br/>
					</div>
				</div>
				<!-- 하단 끝 -->
		...
		<div class="col-lg-6 text-left">
			...
			<div class="">
				<!-- 상단 -->
				<div class="">
					<h1>JAVA Test - Level Selecting</h1>
					<hr>
				...
				<div class="">
					...
					<br/>
					<div class="btn-group">
						<button type="button" class="btn btn-default btn-lg" onclick="location.href='/qboard/study.qu/JAVA/1/0'">level 1</button>
						<button type="button" class="btn btn-default btn-lg" onclick="location.href='/qboard/study.qu/JAVA/2/0'">level 2</button>
						<button type="button" class="btn btn-default btn-lg" onclick="location.href='/qboard/study.qu/JAVA/3/0'">level 3</button>
						<button type="button" class="btn btn-default btn-lg" onclick="location.href='/qboard/study.qu/JAVA/4/0'">level 4</button>
						<button type="button" class="btn btn-default btn-lg" onclick="location.href='/qboard/study.qu/JAVA/5/0'">level 5</button>
					</div>
					<div class="btn-group">
						<button type="button" class="btn btn-default btn-lg" onclick="location.href='/qboard/study.qu/JAVA/6/0'">level 6</button>
						<button type="button" class="btn btn-default btn-lg" onclick="location.href='/qboard/study.qu/JAVA/7/0'">level 7</button>
						<button type="button" class="btn btn-default btn-lg" onclick="location.href='/qboard/study.qu/JAVA/8/0'">level 8</button>
						<button type="button" class="btn btn-default btn-lg" onclick="location.href='/qboard/study.qu/JAVA/9/0'">level 9</button>
						<button type="button" class="btn btn-default btn-lg" onclick="location.href='/qboard/study.qu/JAVA/10/0'">level 10</button>
					</div>
				</div>
				<!-- 하단 끝 -->
			</div>
