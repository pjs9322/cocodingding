			...
			<div class="">
				...
				<div class="">
					...
					<div class="btn-group">
						...
						<button type="button" class="btn btn-default btn-lg" onclick="location.href='/qboard/study.qu/DataBase/1/0'">자동문제 풀어보기</button>
						<br/>
					</div>
				</div>
				<!-- 하단 끝 -->
		...
		<div class="col-lg-6 text-left">
			...
			<div class="">
				...
				<div class="">
					...
					<br/>
					<div class="btn-group">
						<button type="button" class="btn btn-default btn-lg" onclick="location.href='/qboard/study.qu/DataBase/1/0'">level 1</button>
						<button type="button" class="btn btn-default btn-lg" onclick="location.href='/qboard/study.qu/DataBase/2/0'">level 2</button>
						<button type="button" class="btn btn-default btn-lg" onclick="location.href='/qboard/study.qu/DataBase/3/0'">level 3</button>
						<button type="button" class="btn btn-default btn-lg" onclick="location.href='/qboard/study.qu/DataBase/4/0'">level 4</button>
						<button type="button" class="btn btn-default btn-lg" onclick="location.href='/qboard/study.qu/DataBase/5/0'">level 5</button>
					</div>
					<div class="btn-group">
						<button type="button" class="btn btn-default btn-lg" onclick="location.href='/qboard/study.qu/DataBase/6/0'">level 6</button>
						<button type="button" class="btn btn-default btn-lg" onclick="location.href='/qboard/study.qu/DataBase/7/0'">level 7</button>
						<button type="button" class="btn btn-default btn-lg" onclick="location.href='/qboard/study.qu/DataBase/8/0'">level 8</button>
						<button type="button" class="btn btn-default btn-lg" onclick="location.href='/qboard/study.qu/DataBase/9/0'">level 9</button>
						<button type="button" class="btn btn-default btn-lg" onclick="location.href='/qboard/study.qu/DataBase/10/0'">level 10</button>
					</div>
				</div>
				<!-- 하단 끝 -->
			</div>
