...
//				if (${article.qnum} == $("select[name=qnum]",frm).val()) {
//					$("input[name=field]",frm).val(${article.field});m
//					$("input[name=part]",frm).val(${article.part});
//					$("input[name=levels]",frm).val(${article.levels});
//					$("input[name=documentQ]",frm).val(${article.document});
//					$("input[name=choice1]",frm).val('50');
//					$("input[name=choice1]",frm).val(${article.choice1});
//					$("input[name=choice2]",frm).val(${article.choice2});
//					$("input[name=choice3]",frm).val(${article.choice3});
//					$("input[name=choice4]",frm).val(${article.choice4});
//					$("input[name=result]",frm).val(${article.result});
//				}
																		...
																		<div class="form-group form-group-lg">
																			<div class="col-lg-12">
																				...
																				<div class="col-lg-3 radio">
																					<input type="radio" name="result" id="" value="1" checked style="cursor:auto">
																				</div>
																				<br/>
																			</div>
																			...
																			<div class="col-lg-12">
																				...
																				<div class="col-lg-3 radio">
																					<input type="radio" name="result" id="" value="4" style="cursor:auto">
																				</div>
																				<br/>
																			</div>
																		</div>
